...
# Our modules
import ice_view.block_spectral_identity as block_spectral_identity
import ice_view.chain_spectral as chain_spectral
import ice_view.common.svd_output as svd_output_module
import ice_view.common.funct_water_filter as funct_water
import ice_view.common.xml_ as util_xml
from ice_view.common.constants import Deflate
...
class BlockSpectral(block_spectral_identity.BlockSpectralIdentity):
    ...
    def set_phase_1(self, phase_1, xyz):
        ...
        if self.phase_lock:
            if self.phase_1_lock_at_zero:
                ...
                self._phase_1 += (phase_1 - self._phase_1[x, y, z, 0, 0])
        else:
            if self.phase_1_lock_at_zero:
                self._phase_1[x, y, z, 0, 0] = 0.0
            else:
                self._phase_1[x, y, z, 0, 0] = phase_1


    def get_frequency_shift(self, xyz):
        """ Returns frequency_shift for the voxel at the xyz tuple """
        x, y, z = xyz
        return self._frequency_shift[x, y, z, 0, 0]
    ...
    def set_signal_singular_value_count(self, singular_value_count, xyz):
        ...
        x, y, z = xyz
        self._signal_singular_value_count[x, y, z, 0, 0] = singular_value_count


    def get_do_fit(self, xyz):
        """ Returns do_fit for the voxel at the xyz tuple """
        x, y, z = xyz
        return self._water_filter_do_fit[x, y, z, 0, 0]

    def set_do_fit(self, do_fit, xyz):
        """ Sets do_fit for the voxel at the xyz tuple """
        x, y, z = xyz
        self._water_filter_do_fit[x, y, z, 0, 0] = do_fit
    ...
    def get_svd_output(self, xyz):
        ...
        class for details."""
        x, y, z = xyz
        return self._svd_outputs[x, y, z, 0, 0]
    ...
    def set_svd_output(self, svd_output, xyz):
        ...
        the xyz tuple."""
        x, y, z = xyz
        self._svd_outputs[x, y, z, 0, 0] = svd_output
...
def _test():
    ...
    import ice_view.common.time_ as util_time
