# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Mon Mar 11 18:34:37 2024
#
...
class IceViewUI(wx.Panel):
    def __init__(self, *args, **kwds):
        # begin wxGlade: IceViewUI.__init__
        ...
        self.PanelSpectralUI = wx.Panel(self, wx.ID_ANY)
        sizer_2.Add(self.PanelSpectralUI, 1, wx.EXPAND, 0)

        sizer_3 = wx.BoxSizer(wx.VERTICAL)

        self.NotebookSpectral = wx.Notebook(self.PanelSpectralUI, wx.ID_ANY, style=0)
        sizer_3.Add(self.NotebookSpectral, 1, wx.EXPAND, 0)
        ...
        SizerSpectral.Add(sizer_4, 0, wx.ALIGN_RIGHT | wx.BOTTOM | wx.TOP, 6)

        self.CheckSync = wx.CheckBox(self.PanelSpectral, wx.ID_ANY, "Sync")
        self.CheckSync.Hide()
        sizer_4.Add(self.CheckSync, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 12)

        label_5 = wx.StaticText(self.PanelSpectral, wx.ID_ANY, "Plot B:")
        label_5.Hide()
        sizer_4.Add(label_5, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 2)

        self.ComboDataB = wx.ComboBox(self.PanelSpectral, wx.ID_ANY, choices=[], style=wx.CB_READONLY)
        self.ComboDataB.Hide()
        sizer_4.Add(self.ComboDataB, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 4)
        ...
        sizer_5.Add(LabelFirWidth, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)
        ...
        sizer_5.Add(self.FloatFirWidth, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)

        LabelFirRipple = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "FIR Ripple [dB]: ")
        sizer_5.Add(LabelFirRipple, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)
        ...
        sizer_5.Add(self.FloatFirRipple, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)

        sizer_6 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_15.Add(sizer_6, 1, wx.ALIGN_RIGHT, 0)

        LabelFirExtrapolation = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "Extrapolation: ")
        sizer_6.Add(LabelFirExtrapolation, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)
        ...
        sizer_6.Add(self.ComboFirExtrapMethod, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)

        LabelFirExtrap = wx.StaticText(self.PanelWaterFir, wx.ID_ANY, "    Extrap Pts:")
        sizer_6.Add(LabelFirExtrap, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)

        self.SpinFirExtrapValue = wx.SpinCtrl(self.PanelWaterFir, wx.ID_ANY, "", min=0, max=100)
        self.SpinFirExtrapValue.SetMinSize((60, -1))
        sizer_6.Add(self.SpinFirExtrapValue, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 3)
        ...
        self.label_6 = wx.StaticText(self.PanelSvdControls, wx.ID_ANY, "Data Points:", style=wx.ALIGN_RIGHT)
        grid_sizer_1_copy.Add(self.label_6, 0, wx.ALIGN_RIGHT | wx.EXPAND, 0)
        ...
        self.label_7 = wx.StaticText(self.PanelSvdControls, wx.ID_ANY, "Exponentials:", style=wx.ALIGN_RIGHT)
        grid_sizer_1_copy.Add(self.label_7, 0, wx.ALIGN_RIGHT | wx.EXPAND, 0)
        ...
        sizer_7 = wx.StaticBoxSizer(wx.StaticBox(self.PanelSvdControls, wx.ID_ANY, "Peak Selection Methods"), wx.VERTICAL)
        sizer_44.Add(sizer_7, 0, wx.BOTTOM | wx.EXPAND | wx.TOP, 0)

        sizer_8 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_7.Add(sizer_8, 1, wx.EXPAND | wx.TOP, 0)

        self.RadioSvdManual = wx.RadioButton(self.PanelSvdControls, wx.ID_ANY, "Check Box", style=wx.RB_GROUP)
        sizer_8.Add(self.RadioSvdManual, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)

        self.RadioSvdCursorSpan = wx.RadioButton(self.PanelSvdControls, wx.ID_ANY, "Cursor Span")
        sizer_8.Add(self.RadioSvdCursorSpan, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)

        self.RadioSvdApplyThreshold = wx.RadioButton(self.PanelSvdControls, wx.ID_ANY, "Threshold: ")
        sizer_8.Add(self.RadioSvdApplyThreshold, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        sizer_8.Add(self.FloatSvdThreshold, 0, 0, 0)

        self.ComboSvdThresholdUnit = wx.ComboBox(self.PanelSvdControls, wx.ID_ANY, choices=["Hz", "PPM"], style=wx.CB_READONLY)
        sizer_8.Add(self.ComboSvdThresholdUnit, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        sizer_9 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_7.Add(sizer_9, 0, wx.BOTTOM | wx.EXPAND | wx.TOP, 6)

        self.CheckSvdExcludeLipid = wx.CheckBox(self.PanelSvdControls, wx.ID_ANY, " Exclude Lipid Region - Start [PPM]: ")
        sizer_9.Add(self.CheckSvdExcludeLipid, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 4)
        ...
        sizer_9.Add(self.FloatSvdExcludeLipidStart, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.label_10 = wx.StaticText(self.PanelSvdControls, wx.ID_ANY, "    End: ")
        sizer_9.Add(self.label_10, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_9.Add(self.FloatSvdExcludeLipidEnd, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        sizer_9.Add((0, 0), 0, 0, 0)

        sizer_6_copy = wx.BoxSizer(wx.HORIZONTAL)
        sizer_7.Add(sizer_6_copy, 0, wx.EXPAND | wx.TOP, 2)
        ...
        self.PanelHeader = wx.Panel(self.NotebookSpectral, wx.ID_ANY)
        self.NotebookSpectral.AddPage(self.PanelHeader, "Header")
        ...
        label_12 = wx.StaticText(self.PanelHeader, wx.ID_ANY, "Search : ")
        sizer_11.Add(label_12, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.TextSearch = wx.TextCtrl(self.PanelHeader, wx.ID_ANY, "")
        sizer_11.Add(self.TextSearch, 1, wx.ALIGN_CENTER_VERTICAL, 0)

        self.ButtonPrev = wx.Button(self.PanelHeader, wx.ID_ANY, "Prev")
        sizer_11.Add(self.ButtonPrev, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.ButtonNext = wx.Button(self.PanelHeader, wx.ID_ANY, "Next")
        sizer_11.Add(self.ButtonNext, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.PanelSTC = wx.Panel(self.PanelHeader, wx.ID_ANY)
        sizer_10.Add(self.PanelSTC, 1, wx.EXPAND, 0)

        self.PanelHeader.SetSizer(sizer_10)
        ...
        self.PanelSpectralUI.SetSizer(sizer_3)
        ...
        self.Bind(wx.EVT_TEXT_ENTER, self.on_search, self.TextSearch)
        self.Bind(wx.EVT_BUTTON, self.on_prev, self.ButtonPrev)
        self.Bind(wx.EVT_BUTTON, self.on_next, self.ButtonNext)
        # end wxGlade

    def on_voxel(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_voxel' not implemented!")
        event.Skip()

    def on_splitter(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_splitter' not implemented!")
        event.Skip()

    def on_sync(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_sync' not implemented!")
        event.Skip()

    def on_combo_dataB(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_combo_dataB' not implemented!")
        event.Skip()

    def on_flip(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_flip' not implemented!")
        event.Skip()

    def on_fft(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_fft' not implemented!")
        event.Skip()

    def on_chop(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_chop' not implemented!")
        event.Skip()

    def on_water_method(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_water_method' not implemented!")
        event.Skip()

    def on_fir_length(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_fir_length' not implemented!")
        event.Skip()

    def on_fir_width(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_fir_width' not implemented!")
        event.Skip()

    def on_fir_ripple(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_fir_ripple' not implemented!")
        event.Skip()

    def on_fir_extrap_method(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_fir_extrap_method' not implemented!")
        event.Skip()

    def on_fir_extrap_value(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_fir_extrap_value' not implemented!")
        event.Skip()

    def on_ham_length(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_ham_length' not implemented!")
        event.Skip()

    def on_ham_extrap_method(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_ham_extrap_method' not implemented!")
        event.Skip()

    def on_ham_extrap_value(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_ham_extrap_value' not implemented!")
        event.Skip()

    def on_zero_fill(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_zero_fill' not implemented!")
        event.Skip()

    def on_apodization_method(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_apodization_method' not implemented!")
        event.Skip()

    def on_apodization_value(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_apodization_value' not implemented!")
        event.Skip()

    def on_frequency_shift_lock(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_frequency_shift_lock' not implemented!")
        event.Skip()

    def on_b0_shift(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_b0_shift' not implemented!")
        event.Skip()

    def on_amplitude(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_amplitude' not implemented!")
        event.Skip()

    def on_phase_lock(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_phase_lock' not implemented!")
        event.Skip()

    def on_phase0(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_phase0' not implemented!")
        event.Skip()

    def on_phase1_zero(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_phase1_zero' not implemented!")
        event.Skip()

    def on_phase1(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_phase1' not implemented!")
        event.Skip()

    def on_phase1_pivot(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_phase1_pivot' not implemented!")
        event.Skip()

    def on_dc_offset(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_dc_offset' not implemented!")
        event.Skip()

    def on_left_shift_correction(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_left_shift_correction' not implemented!")
        event.Skip()

    def on_left_shift_value(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_left_shift_value' not implemented!")
        event.Skip()

    def on_user_function(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_user_function' not implemented!")
        event.Skip()

    def do_process_all(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'do_process_all' not implemented!")
        event.Skip()

    def on_reset_all(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_reset_all' not implemented!")
        event.Skip()

    def on_svd_manual(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_manual' not implemented!")
        event.Skip()

    def on_svd_cursor_span_picks_lines(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_cursor_span_picks_lines' not implemented!")
        event.Skip()

    def on_svd_apply_threshold(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_apply_threshold' not implemented!")
        event.Skip()

    def on_svd_threshold(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_threshold' not implemented!")
        event.Skip()

    def on_svd_threshold_unit(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_threshold_unit' not implemented!")
        event.Skip()

    def on_svd_exclude_lipid(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_exclude_lipid' not implemented!")
        event.Skip()

    def on_svd_exclude_lipid_start(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_exclude_lipid_start' not implemented!")
        event.Skip()

    def on_svd_exclude_lipid_end(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_svd_exclude_lipid_end' not implemented!")
        event.Skip()

    def on_all_on(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_all_on' not implemented!")
        event.Skip()

    def on_all_off(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_all_off' not implemented!")
        event.Skip()

    def on_search(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_search' not implemented!")
        event.Skip()

    def on_prev(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_prev' not implemented!")
        event.Skip()

    def on_next(self, event):  # wxGlade: IceViewUI.<event_handler>
        print("Event handler 'on_next' not implemented!")
        event.Skip()

# end of class IceViewUI
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetSize((677, 956))
        self.SetTitle("frame_1")

        sizer_1 = wx.BoxSizer(wx.VERTICAL)

        self.IceViewUI = IceViewUI(self, wx.ID_ANY)
        sizer_1.Add(self.IceViewUI, 1, wx.EXPAND, 0)
