...
'other'. This base class is subclassed to indicate to IceView what the
...
from ice_view.common.base_transform import BaseTransform, transformation_matrix, rotation_matrix, requires_transform
